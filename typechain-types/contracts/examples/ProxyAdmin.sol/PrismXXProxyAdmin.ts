...
export interface PrismXXProxyAdminInterface extends utils.Interface {
  functions: {
...
export interface PrismXXProxyAdmin extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PrismXXProxyAdminInterface;
